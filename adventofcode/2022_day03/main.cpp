...
int main()
{
    ...
    for (stringstream file(input()); getline(file, str);)
    {
        ...
        set<char> set1(str.begin(), str.begin() + half);
        auto ch2 = *find_if(str.begin() + half, str.end(), [&](char ch) { return set1.count(ch); });
...
string input()
{
    return R"(qFdBBvtHHfvRlfvsqldvqjPpQmnQmjnjjjTRTLGRNG
