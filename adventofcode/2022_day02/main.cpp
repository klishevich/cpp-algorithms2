...
int main()
{
    ...
    for (stringstream file(input()); getline(file, str);)
    {
        ...
        int my_move = shape_score[vect.at(1)];
        // cout << "opponent " << opponent_move << " my " << my_move << endl;
        int reminder = (3 + my_move - opponent_move) % 3;
        // cout << "reminder " << reminder << endl;
        int game_score = my_move + outcome_score[reminder];
